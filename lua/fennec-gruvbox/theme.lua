...
function M.setup(config)
  ...
  theme.base = {
    ...
    Folded = { fg = c.comment },
    IncSearch = { fg = c.background, bg = c.soft_yellow },
    LineNr = { fg = c.medium_gray },
    MatchParen = { fg = c.foreground, bg = c.comment, style = "underline" },
    ...
    WildMenu = { fg = c.background, bg = c.comment },
    ...
    htmlH1 = { fg = c.red },
    htmlH2 = { fg = c.orange },
    htmlH3 = { fg = c.soft_yellow },
    htmlH4 = { fg = c.soft_green },
    htmlH5 = { fg = c.light_blue },
    htmlH6 = { fg = c.blue_gray },
    ...
    markdownH3 = { fg = c.soft_yellow },
    markdownH4 = { fg = c.soft_green },
    markdownH5 = { fg = c.light_blue },
    markdownH6 = { fg = c.blue_gray },
    ...
    mkdBoldItalic = { fg = c.comment, gui = "bold, italic" },
    -- htmlBoldItalic = { fg = c.red, gui = "bold, italic" },
    mkdBold = { fg = c.comment, gui = "bold" },
    -- mkdFootnotes = {},
    mkdInlineURL = { fg = c.soft_green },
